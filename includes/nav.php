...
<nav class="hidden md:flex space-x-8 items-center">
    ...
    <a href="<?php echo $base_path ?? ''; ?>index.php#collection" class="text-white hover:text-amber-600 text-[10px] font-black tracking-[0.5em] transition-all uppercase no-underline"><?php echo __('collection'); ?></a>
