...
<nav class="hidden md:flex space-x-12 items-center">
    <a href="index.php" class="text-white hover:text-amber-600 text-[11px] font-bold tracking-[0.4em] transition-all uppercase">Home</a>
    <a href="index.php#collection" class="text-white hover:text-amber-600 text-[11px] font-bold tracking-[0.4em] transition-all uppercase">Collection</a>
    <a href="track-order.php" class="text-white hover:text-amber-600 text-[11px] font-bold tracking-[0.4em] transition-all uppercase">Track</a>
    <a href="contact.php" class="text-white hover:text-amber-600 text-[11px] font-bold tracking-[0.4em] transition-all uppercase">Contact Us</a>
</nav>
...
<div class="flex items-center space-x-6">
    ...
    <div class="flex items-center space-x-4">
        ...
        <a href="admin/login.php" class="p-2 text-white/60 hover:text-white transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-user w-5 h-5 group-hover:text-amber-600 transition-all"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
        </a>
    </div>
</div>
